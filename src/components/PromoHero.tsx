        ...
        <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6">
          ...
          <div className="max-w-3xl space-y-2">
            ...
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-serif font-bold text-[#FBF2E3] tracking-tight">
              Merdeka Berani Glowing
            </h2>

            <p className="text-sm sm:text-base text-rose-100 font-light leading-relaxed">
              Dapatkan kulit sehat, cerah, dan bebas masalah dengan penawaran treatment terbaik. 
              Tersedia <span className="font-semibold text-white underline decoration-[#C9A86A]">Cicilan 0% Paylater</span> & <span className="font-semibold text-white">Cashback hingga 500 RB</span>!
            </p>
            ...
            <div className="pt-2 flex flex-wrap items-center gap-2 sm:gap-4 text-xs text-rose-200">
              <div className="flex items-center gap-1.5 bg-black/20 px-2.5 py-1 rounded-lg border border-white/10">
                ...
                <span>Indodana • Kredivo • Atome • SPayLater • BCA • BRI • Mandiri</span>
              </div>
              <div className="flex items-center gap-1.5 bg-black/20 px-2.5 py-1 rounded-lg border border-white/10">
                <ShieldCheck className="w-3.5 h-3.5 text-[#E8BF87]" />
                <span>DP Booking Rp 50.000 (Masa Berlaku 6 Bulan)</span>
              </div>
            </div>
          </div>
