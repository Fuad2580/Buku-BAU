        ...
        <div className="flex-1 overflow-y-auto p-5 space-y-6">
          ...
          <div>
            <h4 className="text-sm font-bold text-stone-900 mb-3 flex items-center gap-2">
              ...
              Langkah Cepat Deployment (Hanya 3 Menit)
            </h4>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-3">
              ...
              <div className="bg-stone-50 p-3.5 rounded-2xl border border-stone-200">
                ...
                <h5 className="font-bold text-xs text-stone-900">Buka Google Apps Script</h5>
                <p className="text-[11px] text-stone-600 mt-1">
                  Buka <a href="https://script.google.com" target="_blank" rel="noreferrer" className="text-[#6B1D2F] font-bold underline">script.google.com</a> dan buat <strong>"Project Baru"</strong>.
                </p>
              </div>
              ...
              <div className="bg-stone-50 p-3.5 rounded-2xl border border-stone-200">
                ...
                <p className="text-[11px] text-stone-600 mt-1">
                  Salin tab <strong>Code.gs</strong> ke file <code className="bg-stone-200 px-1 rounded text-[10px]">Code.gs</code>. Lalu tambah file HTML baru bernama <code className="bg-stone-200 px-1 rounded text-[10px]">Index</code> dan salin tab <strong>Index.html</strong>.
                </p>
              </div>
              ...
              <div className="bg-amber-50 p-3.5 rounded-2xl border border-amber-200">
                <div className="flex items-center justify-between mb-2">
                  <span className="text-[10px] font-bold text-amber-800 uppercase">Langkah 3 (Penting!)</span>
                ...
                <p className="text-[11px] text-stone-700 mt-1">
                  Pilih fungsi <strong>setupSpreadsheet</strong> lalu klik <strong>Run</strong>. Izinkan otorisasi Google Drive agar Spreadsheet database otomatis terbuat di Drive Anda!
                </p>
              </div>
              ...
              <div className="bg-emerald-50 p-3.5 rounded-2xl border border-emerald-200">
                ...
                <p className="text-[11px] text-stone-700 mt-1">
                  Klik <strong>Deploy &gt; Manage deployments &gt; Edit (atau New deployment)</strong>. Atur <em>"Who has access: Anyone"</em>. Klik <strong>Deploy</strong>. Web app langsung aktif!
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-amber-50/80 border border-amber-200/90 p-4 rounded-2xl flex items-start gap-3 text-xs text-amber-950">
            ...
            <div>
              <span className="font-bold text-amber-900 block mb-1">
                Solusi jika sebelumnya web app "Loading Mulu":
              </span>
              <ul className="list-disc list-inside space-y-1 text-amber-900/90 leading-relaxed">
                <li>
                  <strong>Pembaruan Instan (Zero-Lag):</strong> Kode <code className="bg-white/80 px-1 py-0.5 rounded font-mono font-bold">Code.gs</code> dan <code className="bg-white/80 px-1 py-0.5 rounded font-mono font-bold">Index.html</code> di bawah sudah diperbarui dengan sistem <em>preloaded data & fail-safe fallback</em>. Web App akan langsung tampil &lt;0.1 detik tanpa spinner tanpa batas.
                </li>
                <li>
                  <strong>Izin Google Drive:</strong> Di editor Apps Script, pilih dropdown fungsi <strong>setupSpreadsheet</strong>, klik tombol <strong>Run ▶️</strong>, lalu klik <em>"Review Permissions" &gt; pilih email Anda &gt; "Advanced" &gt; "Go to SOZO (unsafe)" &gt; "Allow"</em>.
                </li>
                <li>
                  <strong>Perbarui Deployment:</strong> Klik <strong>Deploy &gt; Manage deployments</strong>, klik ikon pensil (Edit), pilih versi <strong>"New version"</strong>, lalu klik <strong>Deploy</strong> agar script terbaru aktif.
                </li>
              </ul>
            </div>
          </div>
